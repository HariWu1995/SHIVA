...
def get_args():
    ...
    parser.add_argument('--lora_keys', type=str, default=['to_q','to_k','to_v','to_out'], nargs='*')
    parser.add_argument('--ignore_key', type=str, default="bias")
    parser.add_argument('--lora_scale', type=float, default=1.0)
    parser.add_argument('--lora_ckpt_path', type=str, default=True)
    parser.add_argument('--unet_ckpt_path', type=str, default=True, help='root path of the sd1.5 model')
    parser.add_argument('--unet_config_path', type=str, default=True, help='path to unet config, in the `unet` subfolder of args.unet_ckpt_path')
    parser.add_argument('--unet_save_path', type=str, default=True, help='args.unet_ckpt_path + a new subfolder name')
