...
class UNetMidBlock3DCrossAttn(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, 
                ...
                motion_module_alpha=1., cross_attention_kwargs=None, 
...
class CrossAttnDownBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, 
                encoder_hidden_states=None, attention_mask=None,
                motion_module_alpha=1., cross_attention_kwargs={}, 
        ...
        for resnet, attn, motion_module in zip(self.resnets, self.attentions, self.motion_modules):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = checkpoint(create_custom_forward(resnet), hidden_states, temb)
                hidden_states = checkpoint(create_custom_forward(attn, 
                                                    return_dict=False), hidden_states, encoder_hidden_states)[0]
                if motion_module is not None:
