...
class TemporalTransformer3DModel(nn.Module):
    ...
    def __init__(
        ...
        assert (not causal_temporal_attention) \
                or (causal_temporal_attention_mask_type != "")
        ...
        self.norm = InflatedGroupNorm(num_channels=in_channels, num_groups=norm_num_groups, eps=1e-6, affine=True)
    ...
    def get_causal_temporal_attention_mask(self, hidden_states):
        ...
        if self.causal_temporal_attention_mask is None \
        or self.causal_temporal_attention_mask.shape != (B, seq_len, seq_len):
    ...
    def forward(self, hidden_states, 
        ...
        if self.causal_temporal_attention:
            attention_mask = self.get_causal_temporal_attention_mask(hidden_states)
        ...
        hidden_states = rearrange(hidden_states, "(b h w) f c -> b c f h w", h=H, w=W)
...
class TemporalSelfAttention(Attention):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.pos_encoder = PositionalEncoding(kwargs["query_dim"],
