...
class StableVideoDiffusionPipelinePoseCond(DiffusionPipeline):
    ...
    def decode_latents(self, latents, num_frames, decode_chunk_size=1):
    ...
    def check_inputs(self, image, height, width):
        ...
        and not isinstance(image, (list, tuple))
        ):
            raise ValueError(
    ...
    def __call__(
        ...
        Args:
            ...
            decode_chunk_size (`int`, *optional*):
                ...
                The higher the chunk size, the higher the temporal consistency between frames, 
                                    but also the higher the memory consumption. 
        ...
        if decode_chunk_size is None or decode_chunk_size <= 0:
        ...
        # 5. Prepare latent variables: [bs, frame, c, h, w]
