...
class DSINE_v02_kappa(nn.Module):
    ...
    def __init__(self, args):
        ...
        print('Defining DSINE_v02_kappa (DSINE_v02 + also estimates uncertainty)')
        print('B: %s / NF: %s / BN: %s / down: %s / learned_upsampling: %s' % (B, NF, BN, down, learned_upsampling))
        print('ps: %s / iter train: %s / iter test: %s / v_relu: %s' % (self.ps, self.num_iter_train, self.num_iter_test, self.v_relu))
