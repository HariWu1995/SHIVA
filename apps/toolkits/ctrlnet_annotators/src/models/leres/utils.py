...
def get_func(func_name):
    ...
    `func_name` must identify a function in this module 
                            or path to a function relative to the base 'modeling' module.
    """
    if func_name == '':
        return None
    try:
        ...
        # module_dir = 'annotator.leres.leres.'
        module_dir = 'apps.preprocessing.ctrlnet_annotators.src.models.leres.'
        module_name = module_dir + '.'.join(parts[:-1])
