...
def forward_vit(pretrained, x):
    ...
    unflatten = nn.Sequential(
        nn.Unflatten(
            2,
            torch.Size([h // pretrained.model.patch_size[1], 
...
def forward_flex(self, x):
    ...
    if getattr(self, "dist_token", None) is not None:
        cls_tokens = self.cls_token.expand(B, -1, -1)   # implemented from Phil Wang
...
def _make_pretrained_vitl16_384(pretrained, use_readout="ignore", hooks=None, **kwargs):
...
def _make_pretrained_vitb16_384(pretrained, use_readout="ignore", hooks=None, **kwargs):
...
def _make_pretrained_deitb16_384(pretrained, use_readout="ignore", hooks=None, **kwargs):
...
def _make_pretrained_deitb16_distil_384(pretrained, use_readout="ignore", hooks=None, **kwargs):
...
def _make_pretrained_vitb_rn50_384(
    pretrained, use_readout="ignore", hooks=None, use_vit_only=False, **kwargs
):
