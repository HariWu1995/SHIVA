...
def _make_scratch(in_shape, out_shape, groups=1, expand=False):
    ...
    conv_kwargs = dict(kernel_size=3, stride=1, padding=1, bias=False, groups=groups)

    scratch.layer1_rn = nn.Conv2d(in_shape[0], out_shape1, **conv_kwargs)
    scratch.layer2_rn = nn.Conv2d(in_shape[1], out_shape2, **conv_kwargs)
    scratch.layer3_rn = nn.Conv2d(in_shape[2], out_shape3, **conv_kwargs)
    scratch.layer4_rn = nn.Conv2d(in_shape[3], out_shape4, **conv_kwargs)
