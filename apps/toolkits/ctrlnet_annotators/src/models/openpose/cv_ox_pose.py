...
def _get_3rd_point(a: np.ndarray, b: np.ndarray) -> np.ndarray:
    ...
    The 3rd point is defined by rotating vector `a - b` by 90 degrees anticlockwise, 
    using b as the rotation center.
...
def inference_pose(session, out_bbox, image, model_input_size: Tuple[int, int]= (288, 384) ):
    resized_img, center, scale = preprocess(image, out_bbox, model_input_size)
