...
from . import (
    shared as ui, 
    ui_chat, ui_default, ui_file, ui_model, ui_notebook, ui_session, 
    extensions,
)
from .utils import (
...
def create_ui(min_width: int = 25):
    ...
    with gr.Blocks(**interface_kwargs) as ui.gradio['interface']:
        ...
        ui.gradio['interface'].load(None, gradget('show_controls'), None, js=interface_launch_js)
