...
from src.chat import generate_chat_prompt
...
def input_modifier(string, state):
    ...
    In chat mode, it is the same as chat_input_modifier 
    but only applied to "text", here called "string", 
            and not to "visible_text".
    """
    return string
...
def create_ui():
    ...
    Custom gradio elements and their corresponding event handlers should be defined here.
