...
class GrammarConstrainedLogitsProcessor(LogitsProcessor):
    ...
    def process_logits(self, input_ids, scores, parse_start_index=None):
        ...
        #  (i.e., one token at a time).
            ...
            raise RuntimeError(
                "Input ID's length is inconsistent with the current state of the GrammarConstrainedLogitsProcessor. "
                "If you want to process another input sequence, instantiate a new GrammarConstrainedLogitsProcessor."
            )
