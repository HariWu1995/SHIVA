...
def my_open(*args, **kwargs):
    ...
    if filename.endswith(('index.html', 'share.html')):
        ...
        file_contents = file_contents.replace(
            ...
            f'\n    <link id="highlight-css" rel="stylesheet" href="file/css/highlightjs/{"github-dark" if ui.settings["dark_theme"] else "github"}.min.css">'
            '\n    <script>hljs.addPlugin(new CopyButtonPlugin());</script>'
            f'\n    <script>{ui.js["global_scope"]}</script>'
            '\n  </head>'
        )
