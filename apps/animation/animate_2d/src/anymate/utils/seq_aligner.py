...
def global_align(x, y, score):
    ...
    traceback = get_traceback_matrix(len(x), len(y))
...
def get_aligned_sequences(x, y, traceback):
    x_seq = []
    y_seq = []
...
def get_mapper(x: str, y: str, tokenizer, max_len=77):
    ...
    matrix, traceback = global_align(x_seq, y_seq, score)
    mapper_base = get_aligned_sequences(x_seq, y_seq, traceback)[-1]
