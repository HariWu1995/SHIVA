...
def get_scheduler(optimizer, opt):
    """R
    eturn a learning rate scheduler
...
def init_weights(net, init_type='normal', init_gain=0.02):
    ...
    But xavier and kaiming might work better for some applications. Feel free to try yourself.
    """
...
def calculate_gradient_penalty(netD, real_data, fake_data, device, type='mixed', constant=1.0, lambda_gp=10.0):
    """
