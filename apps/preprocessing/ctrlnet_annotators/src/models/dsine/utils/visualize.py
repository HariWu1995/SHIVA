...
def normal_to_rgb(normal, normal_mask=None):
    """ 
    surface normal map to RGB (used for visualization)
...
def normal_to_uint8(normal, valid_mask):
    """ 
    surface normal map to uint8 (used to generate ground truth)
...
def normal_to_uint16(normal, valid_mask):
    """ 
    surface normal map to uint16 (used to generate ground truth)
...
def alpha_to_jet(pred_alpha, a_max=60.0):
    """ 
    Uncertainty alpha to JET (used for visualization)
    """
