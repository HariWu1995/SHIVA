...
def draw_pupils(image, landmark_list, drawing_spec, half_width: int = 2):
    """
    We have a custom function to draw the pupils 
    because the mp.draw_landmarks method requires a parameter for all landmarks.
    ...
    for idx, landmark in enumerate(landmark_list.landmark):
        if (
            ...
            continue
        if landmark.x >= 1.0 or landmark.x < 0 \
        or landmark.y >= 1.0 or landmark.y < 0:
            continue
        ...
        image[image_y - half_width : image_y + half_width, 
              image_x - half_width : image_x + half_width, :] = draw_color
...
def generate_annotation(
    ...
    If min_face_size_pixels is provided and nonzero,
