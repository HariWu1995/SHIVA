...
submodule_path = osp.realpath(osp.join(osp.dirname(__file__), "extra"))
...
class Dust3r:
    ...
    def infer_cameras_and_points(
        ...
        if num_img == 1:
            print("Only 1 image found, duplicating it to create a stereo pair.")
        ...
        _ = scene.compute_global_alignment(init="msp", niter=niter, schedule=schedule, lr=lr)
